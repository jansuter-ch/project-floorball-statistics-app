...
2. On the home portal, click "Create new app"
3. Select "Import app"
4. Upload the `db.txt` file from the root of this repository
5. Name the app and confirm the import
6. The app will open with all screens and datasource configuration already in place
